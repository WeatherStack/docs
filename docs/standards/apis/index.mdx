...
|                          Method                          | Purpose                          |
| :------------------------------------------------------: | :------------------------------- |
|               <HttpMethod method="GET" />                | Retrieving data                  |
|               <HttpMethod method="POST" />               | Creating new data/resources      |
| <HttpMethod method="PUT" /><HttpMethod method="PATCH" /> | Updating existing data/resources |
|              <HttpMethod method="DELETE" />              | Removing existing data/resources |
