...
You may wish to connect a camera to the Raspberry Pi (or any other device that can run Linux) to take photos of the sky at set intervals (Same as, or different to the data collection interval),
