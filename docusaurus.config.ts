...
const config: Config = {
  title: 'WeatherStack',
  tagline: 'Customisable, open-source weather station software',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/weatherstack/docs/tree/main/',
  ...
  themeConfig: {
    ...
    footer: {
          ...
          items: [
            {
              ...
              href: 'https://stackoverflow.com/questions/tagged/weatherstack',
            },
            {
              label: 'Discord',
      ...
      copyright: `Copyright © ${new Date().getFullYear()} WeatherStack. Built with Docusaurus.`,
    },
    prism: {
